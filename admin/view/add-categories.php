                          ...
                          <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="cate_code_type" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <textarea name="cate_description" class="form-control" rows="4"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <br>
                                <input type="submit" value="Create new Categories" name="add_category" class="btn btn-success float-right">
                            </div>
                            <!-- /.card-body -->
                          </div>
                    </form>
